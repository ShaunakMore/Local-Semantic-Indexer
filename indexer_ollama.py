...
def check_indexing(folder_path):
    ...
    vec_db_path = folder/".index_cache"/"index.bin"
    image_map_path = folder/".index_cache"/"image_map.pkl"
    ...
    if vec_db_path.exists() and image_map_path.exists():
        ...
        if missing:
            ...
            with open(folder/".index_cache"/"image_map.pkl","wb") as f:
        ...
        hidden_dir = os.path.join(folder, ".index_cache")
